...
\address{Aktueller Stand: {\em May 2026} \small{(\href{https://github.com/jneidel/cv}{\gitRevId})}}
...
\begin{rSection}{Beschreibung}
  ...
  \begin{minipage}[t]{\skillWidth\linewidth}
    ...
    Ich bin ein Senior Backend Software Engineer der strukturiert denkt, ehrlich kommuniziert, seine eigenen Ideen einbringt und diese auch in die Umsetzung bringt.
    ...
    Vom Anfang an have ich immer an echten Projekten gearbeitet.

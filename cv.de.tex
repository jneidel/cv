...
\address{Aktueller Stand: {\em Jun 2026} \small{(\href{https://github.com/jneidel/cv}{\gitRevId})}}
...
\begin{rSection}{Beschreibung}
  ...
  \begin{minipage}[t]{\skillWidth\linewidth}
    ...
    Ich bin ein Senior Backend Software Engineer der strukturiert denkt, ehrlich kommuniziert, seine eigenen Ideen mit einbringt und diese auch umsetzt.

    \medskip

    Ich habe aus Neugier mit dem Programmieren begonnen.
    Was mich wirklich überzeugte, mich diesem Feld zu widmen, war das Potenzial eine Vielzahl von Problemen für mich und andere zu lösen.
    Für mich geht es beim Software Engineering darum für Menschen einen Mehrwert zu erschaffen.

    \medskip

    Meine Expertise lässt sich in zwei ergänzende Teile aufgespalten.
    ...
    und kooperativen Weise zu schaffen.

    \medskip

    Vom Anfang an habe ich immer an echten Projekten gearbeitet.
    Je nachdem was benötigt wurde habe ich APIs, ganze Webapps und vollumfängliche Kommandozeilen Apps gebaut.
    Besonders greife ich dabei auf Scripting zurück.
    Ich automatisiere alle Prozesse die mir sowohl im Privatleben als auch auf
    der Arbeit über den Weg laufen und bei denen es Sinn ergibt.
  ...
  \begin{minipage}[t]{\skillWidth\linewidth}
    ...
    Im Umgang mit bisherigen Herausforderungen bin ich mit folgenden Werkzeuge vertraut geworden oder habe sie gar gemeistert:
    ...
    \begin{itemize}
      ...
      \item Linux, System Administrierung, vim, Emacs
...
\begin{rSection}{Lebenslauf}
  ...
  \hfill {\em Feb 2022 - Mai 2026}

  Bachelorarbeit, Projektarbeit. Angestellt als regulärer Entwickler, befördert bis zum Senior Developer.
  ...
  \smallskip
    ...
    Wordpress, SEO Inhalte, technischer Kundensupport, Scripting.
...
\begin{rSection}{IT Projekte}
  ...
  \textbf{\href{https://tvthek.orf.at/}{ORF TVThek API}}
  \hfill
  ...
  \itemsep -0.5em \vspace{-0.5em}
    \smallskip
  \item \href{https://jneidel.com/dev/technical-documentation-with-arc42/}{Anführen des Neuaufsetzens der technischen Dokumentation} um Entwicklung zu beschleunigen und das Risiko des Wissensverlustes und die Kosten von On-boardings zu minimieren.
  \item Anführen der Modernisierung und Vervollständigung der API Dokumentation um Kommunikationskosten mit QA und Extern zu reduzieren.
  \item Spezifierung und Leitung mehrerer weiter eigener Initiativen.
  \item Automatisierung des Deployment flows und der Changelog Generierung.
  \item Neuentwicklungen des lokalen Entwicklersetups für höhere Dev Produktivität.
  \item Erfolgreiche Spaltung des Teams angetrieben, was durch effizientere Meetings und Prozesse Geld sparte.
  \end{list}
  ...
  \itemsep -0.5em \vspace{-0.5em}
    \smallskip
  \item Automatisierung des Ausfüllen von bürokratisch-erforderlichen PDFs um Zeit zu sparen.
  \end{list}
  ...
  \itemsep -0.5em \vspace{-0.5em}
    \smallskip
  \item Technische Leitung und Projektmanagement zur Entwicklung einer Symfony Webapp.
...
\textbf{\href{https://github.com/htw-kbe-jneidel/main}{Abschlussprojekt zu Komponenten-basierter Entwicklung}}
  \hfill
